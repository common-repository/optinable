...
<div class="op_dashboard_cards">
    <div class="op_inner_card">
        <h3 style=" text-transform: capitalize;width: 200px; position:relative">
            <div><?php esc_html_e("Embed", 'optinable')?> </div>
            <span class="op_list_ini_head"><?php echo esc_html($init_heading);?></span>
            <span class="optinable-frm-tag type-optinlinks">
                <?php esc_html_e( 'Embeds, Inline Posts', 'optinable' ); ?>
            </span>
        </h3>
        <p><?php esc_html_e( 'Effortlessly embed forms and opt-ins into your website for seamless integration.', 'optinable' ); ?></p>
        <a class="op_dashb_cr_button" data-type="embed" href="#create-campaign">
        ...
        <div align="right">
<a href="<?php echo esc_url(get_site_url())?>/wp-admin/admin.php?page=optinable-campaign-list-embed&mod=live" class="op_db_view_all_campaigns _live <?php echo esc_attr($init_heading)?>"><?php esc_html_e( 'Live', 'optinable' ); ?> </a> | 
<a href="<?php echo esc_url(get_site_url())?>/wp-admin/admin.php?page=optinable-campaign-list-embed&mod=unpublished" class="op_db_view_all_campaigns _unpub <?php echo esc_attr($init_heading)?>"><?php esc_html_e( 'UnPublished', 'optinable' ); ?> </a> | 
<a href="<?php echo esc_url(get_site_url())?>/wp-admin/admin.php?page=optinable-campaign-list-embed&mod=archived" class="op_db_view_all_campaigns _arch <?php echo esc_attr($init_heading)?>"><?php esc_html_e( 'Archived', 'optinable' ); ?> </a>
        </div>
